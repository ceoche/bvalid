...
public class BReportTest {
   ...
   void testGetRuleResultCorrect() {
      ...
      assertTrue(Objects.requireNonNull(assertionReport).isValid());
   }
   ...
   void testGetRuleResultIncorrectRule() {
      ...
      assertEquals(3, result.getAllAssertionReports().size());
      assertEquals(1, result.getInvalidAssertions().size());
      assertEquals(1, result.getAllInvalidAssertions().size());
   }
   ...
   void testGetRuleResultWithMemberCorrect() {
      ...
      assertTrue(Objects.requireNonNull(getRuleResult(result, "address [CityValid]")).isValid());
      assertTrue(Objects.requireNonNull(getRuleResult(result, "address [StreetValid]")).isValid());
      assertTrue(Objects.requireNonNull(getRuleResult(result, "address.city [cityNameValid]")).isValid());
      assertFalse(Objects.requireNonNull(getRuleResult(result, "address.city [cityZipcodeValid]")).isValid());
   }
   ...
   void testGetRuleResultWithMemberIncorrect() {
      ...
      assertEquals(4, result.getAllAssertionReports().size());
      assertEquals(0, result.getInvalidAssertions().size());
      assertEquals(2, result.getAllInvalidAssertions().size());
   }
   ...
   void testGetRuleResultWithListMemberCorrect() {
      ...
      assertTrue(Objects.requireNonNull(getRuleResult(result, "person.phones[0] [numberValid]")).isValid());
      assertTrue(Objects.requireNonNull(getRuleResult(result, "person.phones[0] [countryCodeValid]")).isValid());
   ...
   public static AssertionReport getRuleResult(BReport result, String rulePath) {
      ...
      if (elementIsRule(path[1])) {
         for (AssertionReport assertionReport : result.getAssertionReports()) {
